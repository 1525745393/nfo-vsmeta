...
try:
    from PyQt6.QtWidgets import (
        ...
        QGroupBox, QCheckBox, QSpinBox, QComboBox, QScrollArea,
        QSplitter, QFrame, QDialog, QDialogButtonBox, QProgressDialog,
        QGridLayout, QFormLayout, QSlider, QStyle, QSplitterHandle,
        QSizePolicy, QStackedWidget, QHeaderView, QTableWidget, QTableWidgetItem,
        QAbstractItemView
    )
    from PyQt6.QtCore import (
        ...
        QVariant, QMimeData, QUrl, QTimer
    )
    from PyQt6.QtGui import (
        QAction, QIcon, QFont, QPalette, QColor, QPixmap,
        QImage, QPainter, QPen, QBrush, QDragEnterEvent, QDropEvent,
        QStandardItemModel, QStandardItem, QTextCursor, QKeySequence,
        QShortcut, QTextCharFormat, QTextDocument
    )
...
class MainWindow(QMainWindow):
    ...
    def browse_video_file(self):
        """浏览视频文件"""
        formats = " ".join([f"*{fmt}" for fmt in AppConfig.VIDEO_FORMATS])
